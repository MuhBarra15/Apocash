...
class PembelianController extends Controller
{
    ...
    public function data()
    {
        ...
        return datatables()
            ...
            ->addColumn('nomor_faktur', function ($pembelian) {
                return $pembelian->nomor_faktur;
            })
    ...
    public function create($id)
    {
        ...
        $pembelian->nomor_faktur  = 0;
        $pembelian->total_item  = 0;
        $pembelian->total_harga = 0;
        $pembelian->diskon      = 0;
        $pembelian->jatuh_tempo = Carbon::now();
        $pembelian->save();
    ...
    public function store(Request $request)
    {
        ...
        $pembelian->nomor_faktur = $request->nomor_faktur;
