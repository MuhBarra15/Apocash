                        ...
                        <div class="col-lg-5">
                            <div class="input-group">
                                ...
                                <span class="input-group-btn">
                                    <button onclick="tampilProduk()" class="btn btn-info btn-flat" type="button"> + Tambah Obat</i></button>
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4">
                        <form action="{{ route('pembelian.store') }}" class="form-pembelian" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" id="nomor_faktur" class="form-control" name="nomor_faktur">
                                </div>
                            </div>
                            <div class="form-group row">
